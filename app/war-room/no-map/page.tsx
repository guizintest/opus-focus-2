...
export default function NoMapPage() {
  ...
  return (
    <div className="min-h-screen bg-aoe-dark-blue flex flex-col items-center justify-center p-4">
      <div className="bg-aoe-panel border border-aoe-border rounded-lg p-6 max-w-md w-full">
        <h1 className="text-2xl font-cinzel text-aoe-gold mb-4 text-center">Nenhum Mapa Disponível</h1>

        <p className="text-aoe-light mb-6 text-center">
        ...
        <div className="flex flex-col space-y-4">
          <AoE4Button onClick={handleGenerateMap} disabled={loading || success}>
            {loading ? (
              <>
